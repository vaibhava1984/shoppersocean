        ...
        <div className="flex flex-col space-y-2">
            {authorsMenuLists.map((author) => (
                <Button
                    ...
                    className="h-11 justify-start w-full rounded-lg px-4 font-sans text-base font-bold tracking-wide text-rose-800 transition-all duration-200 hover:bg-rose-50 hover:text-rose-950"
