                    ...
                    <div className="overflow-x-auto">
                        <Table>
                            <TableHeader><TableRow>
                                <TableHead>Order Date</TableHead><TableHead>Book Title</TableHead><TableHead>Amount</TableHead><TableHead>Status</TableHead><TableHead>Payment Method</TableHead>
                            ...
                            <TableBody>
                                {purchases.map((purchase) => (
                                    <TableRow key={purchase.id}>
                                        ...
                                        <TableCell>{Number(purchase.payment?.original_amount ?? purchase.original_amount ?? 0).toFixed(2)} {purchase.payment?.original_currency ?? purchase.display_currency ?? purchase.currency ?? ""}</TableCell>
